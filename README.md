...
pipeline.add_stage(
    Destination(
        ...
        # The 'body_template' automatically formats the retrieved data into a GitHub issue comment. "$DATA" will be replaced by the JSON representation of the extracted code snippets.
...
- `GitHubConnectorScannerSource` - Scan and analyze GitHub repository code files via GitHub connector
